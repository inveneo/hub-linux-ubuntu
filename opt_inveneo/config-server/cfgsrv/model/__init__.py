...
# old station configuration table
old_station_table = Table('station', metadata,
...
class Old_Station(object):

    def __init__(self, mac=g.DEFAULT_MAC):
...
mapper(Old_Station, old_station_table)

############
# NEW STUFF
############

# new station configuration table
station_table = Table('station2', metadata,
    Column('mac', types.String(12), primary_key=True),
    Column('on', types.Boolean),
    Column('hostname', types.String(255)),
...
class Station(object):
    ...
    def properties(self):
        ...
        d = {}
        d['INV_HOSTNAME'] = self.hostname
        d['INV_LANG'] = self.lang
        d['INV_LANGUAGE'] = self.language
        d['INV_TIME_ZONE'] = self.time_zone
        d['INV_NTP_ON'] = ['0', '1'][self.ntp_on]
        d['INV_NTP_SERVERS'] = self.ntp_servers
        d['INV_CONFIG_HOST'] = self.config_host
