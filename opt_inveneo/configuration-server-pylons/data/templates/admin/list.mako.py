...
_magic_number = 2
_modified_time = 1194241056.131778
_template_filename='/home/rjocham/pylons/configuration-server/configurationserver/templates/admin/list.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 2
        context.write(unicode(h.form(h.url(controller='admin', action='config_add'), method='post')))
