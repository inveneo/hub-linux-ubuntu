...
def main():
        ...
        for drive_num, logical_name, serial_num, drive_state in all_drive_information:
                if drive_state == 'missing' or drive_state == 'faulty': 
                    print "<td><table><tr><td>Drive Number: %s</td></tr><tr><td>Logical Name: %s</td></tr><tr><td>Serial: %s</td></tr><tr><td>State: <font color='red'>%s</font></td></tr></table></td>" % (drive_num, logical_name, serial_num, drive_state)
                else:
                    print "<td><table><tr><td>Drive Number: %s</td></tr><tr><td>Logical Name: %s</td></tr><tr><td>Serial: %s</td></tr><tr><td>State: %s</td></tr></table></td>" % (drive_num, logical_name, serial_num, drive_state)
        print "</tr></table>"
